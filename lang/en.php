...
// ==============================
// show_price       0   => button "ask pricing"
...
return [
    ...
    'title' => 'Configurator ⚡ Electric Tack Locker 🔋 Hussaria Electra 🚀 Saddle Box',
    'header' => 'Order form',
    'helper' => 'Configure your ELECTRIC SADDLE BOX and submit the form - we will contact you and guide you through the next steps of the order process 😊',
    'form' => [
        'colors' => [
            'title' => 'Color',
            'fields' => [
        ...
        'notification' => [
            'add-package' => 'The product has been added to the cart',
            'update-package' => 'The configuration has been updated',
        ],
        ...
        'person' => [
            ...
            'fields' => [
                ...
                'last_name' => 'Last Name/Tax Identification Number',
                'email' => 'E-mail',
                'phone' => 'Phone',
                'address' => 'Address',
                'city' => 'Town / City',
        ...
        'order' => [
            ...
            'agree' => [
                'title' => 'I accept',
                'name' => 'statute',
                'link' => 'https://electra.hussaria.pl/en/content/16-regulations',
                'shop' => 'of online shop'
            ]
        ],
        'order_summary' => [
    ...
    'package' => [
        ...
        'desc' => 'ELECTRIC SADDLE BOX - order a personalized trunk with an electric drive. The perfect solution for storing saddles and equestrian equipment. Equipped with large wheels and an electric motor, it offers convenience, easy maneuverability, and eliminates physical effort. An excellent choice for riders and equestrian enthusiasts.',
        'keywords' => 'hussaria electra, electric tack locker, electric drive, saddle box',
        'thumb' => 'he_thumb_elektryczna_paka.png',
        'schema' => [
            'name' => 'Electric Tack Locker',
            'image' => 'elektryczna_paka_jezdziecka_he.jpg',
            'currency' => 'EUR',
            'desc' => 'Tack Locker with an electric drive for transporting riding equipment',
    ...
    'products' => [
        ...
        'promo_cap' => [
            ...
            'cta' => [
                ...
                'link' => 'https://elite.hussaria.pl/en/',
            ],
            'colors' => [
                'name' => 'Color',
                'values' => [
    ...
    'success' => [
        'title' => 'Confirmation ⚡ Electric Tack Locker 🔋 Hussaria Electra 🚀',
        'header' => 'Thank you for your order!',
        'content' => 'Your order has been accepted. We\'ve sent you a confirmation via email.',
        'button' => 'return to the Configurator'
    ],
    'cancel' => [
        'title' => 'Cancelled payment ⚡ Electric Tack Locker 🔋 Hussaria Electra 🚀',
        'header' => 'The payment has been canceled or interrupted.',
        'button' => 'return to the Configurator'
    ]
];