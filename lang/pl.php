...
return [
    ...
    'title' => 'Konfigurator ⚡ Elektryczna Paka jeździecka 🔋 Hussaria Electra 🚀',
    'header' => 'Formularz zamówienia',
    'helper' => 'Skonfiguruj swoją ELEKTRYCZNĄ PAKĘ i wyślij formularz, a my skontaktujemy się z Tobą i poprowadzimy Cię przez kolejny etap zamówienia 😊',
    'form' => [
        'colors' => [
            'title' => 'Kolor paki',
            'fields' => [
        ...
        'notification' => [
            'add-package' => 'Produkt został dodany do koszyka',
            'update-package' => 'Konfiguracja została pomyślnie zaktualizowana',
        ],
    ...
    'package' => [
        ...
        'keywords' => 'hussaria electra, elektryczna paka, paka z napędem elektrycznym, paka jeździecka, elektryczna paka jeździecka, transport sprzętu jeździeckiego, siodła, sprzęt jeździecki',
        'thumb' => 'he_thumb_elektryczna_paka.png',
        'schema' => [
            'name' => 'Elektryczna Paka jeździecka',
            'image' => 'elektryczna_paka_jezdziecka_he.jpg',
            'currency' => 'PLN',
            'desc' => 'Paka z napędem elektrycznym do transportu sprzętu jeździeckiego',
        ...
        'shipping' => [
            'active' => 1,
            'content' => 'Elektryczna paka jeździecka',
            'span' => 'z darmową dostawą',
            'info' => 'na terenie całej Polski'
        ],
        'include' => [
            'intro_products' => 'Kupując elektryczną pakę jeździecką otrzymujesz gratis',
            'products' => [
                'battery' => [
                    'active' => 1,
                    'name' => 'Akumulator',
    ...
    'success' => [
        'title' => 'Potwierdzenie ⚡ Elektryczna Paka jeździecka 🔋 Hussaria Electra 🚀',
        'header' => 'Dziękujemy za złożenie zamówienia!',
        'content' => 'Twoje zamówienie zostało przyjęte. Potwierdzenie wysłaliśmy e-mailem.',
        'button' => 'powrót do Konfiguratora'
    ],
    'cancel' => [
        'title' => 'Anulowana płatność ⚡ Elektryczna Paka jeździecka 🔋 Hussaria Electra 🚀',
        'header' => 'Płatność została anulowana lub przerwana.',
        'button' => 'powrót do Konfiguratora'
    ]
];