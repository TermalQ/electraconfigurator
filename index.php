...
<head>
    ...
    <meta name="keywords" content="<?php echo $translate['package']['keywords'] ?>">
    <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1, max-video-preview:-1">
    <meta name="token" content="<?php echo $_SESSION['csrf_token']; ?>">

    <link rel="canonical" href="https://electra.hussaria.pl/configurator/">
    <?php foreach ($languages as $code => $langData): ?>
        <link rel="alternate" href="https://electra.hussaria.pl/configurator/?lang=<?php echo $code; ?>" hreflang="<?php echo $code; ?>">
    <?php endforeach; ?>
    ...
    <script type="application/ld+json">
    {
        ...
        "@type": "Organization",
        "name" : "HUSSARIA",
        "url" : "https://electra.hussaria.pl/configurator/",
            "logo": {
            "@type": "ImageObject",
            "url":"https://electra.hussaria.pl/configurator/img/hussaria_electra_logo_black.png"
        }
    }
    </script>
    ...
    <script type="application/ld+json">
    {
        "@context": "https://schema.org",
        "@type": "Product",
        "name": "<?php echo $translate['package']['schema']['name']; ?>",
        "image": [
            "https://electra.hussaria.pl/configurator/img/<?php echo $translate['package']['schema']['image']; ?>"
        ],
        "description": "<?php echo $translate['package']['schema']['desc']; ?>",
        "brand": {
            "@type": "Brand",
            "name": "<?php echo $translate['package']['schema']['brand']; ?>"
        },
        "offers": {
            "@type": "Offer",
            "url": "https://electra.hussaria.pl/configurator/",
            "priceCurrency": "<?php echo $translate['package']['schema']['currency']; ?>",
            "price": "<?php echo $translate['package']['price']; ?>",
    ...
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-E0WLHK4YG4"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'G-E0WLHK4YG4');
    </script>
...
<body>
        ...
        <div class="row">
            ...
            <div class="col-12 order-sm-1 col-md-3 order-md-1 d-flex align-items-center justify-content-between justify-content-md-start gap-1">
                <div class="logo-wrapper">
                    <a href="https://electra.hussaria.pl/"><img id="logo" class="logo" src="<?php echo version('img/hussaria_electra_logo_black.png') ?>" alt="Hussaria Electra"></a>
                </div>
                <div class="info px-2">
    ...
    <main id="main" class="container-fluid">
        <div class="row configurator position-relative">
            ...
            <!-- CONFIGURATOR -->
            <div class="col-6 col-md-4 col-lg-3 configurator__panel position-absolute z-1 mt-5 top-0 start-0">
                <div class="configurator__panel__options p-1 p-md-3 my-1 my-md-3 step" data-step="1">
                    ...
                    <section class="pack-colors d-flex align-items-center justify-content-between">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-colors d-flex align-items-center dropdown-toggle" type="button" data-bs-toggle="dropdown" tabindex="0" aria-label="<?php echo $translate['form']['colors']['fields']['label'] ?>">
                                        ...
                                        foreach ($category['items'] as $color) {
                                            ...
                                            if($color['active']) {
                                                ...
                                                echo '<a href="#" class="dropdown-item color-txt"
                                                    ...
                                                    data-panel-mode="' . htmlspecialchars($color['filter'], ENT_QUOTES, 'UTF-8') . '"
                                                    ...
                                                    title="' . htmlspecialchars($color['name'][$lang], ENT_QUOTES, 'UTF-8') . '"
                    ...
                    <div class="form-group my-2 settings d-flex justify-content-between align-items-center">
  <div class="fs-6">Wykończenie:</div>

  <!-- Switcher Mat / Błysk -->
  <div class="btn-group" role="group" aria-label="Wykończenie"
       id="finishSwitcher"
       data-option-type="finish"
       data-name="Wykończenie"
       data-price="0">

    <input type="radio" class="btn-check" name="finish_option" id="finish_mat" autocomplete="off" value="mat" checked>
    <label class="btn btn-outline-secondary" for="finish_mat">Mat</label>

    <input type="radio" class="btn-check" name="finish_option" id="finish_blysk" autocomplete="off" value="błysk">
    <label class="btn btn-outline-secondary" for="finish_blysk">Błysk</label>
  </div>
</div>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapse_<?php echo $key; ?>" class="accordion-collapse collapse" data-bs-parent="#textAccordion">
                                                <div class="accordion-body">
                                                    ...
                                                    <!-- Text Align -->
                                                    <div class="d-flex flex-wrap align-items-center justify-content-between settings py-1">
                                                        <div class="fs-6"><?php echo htmlspecialchars($item['help'][$lang]); ?>:</div>
                ...
                <div class="configurator__panel__options p-1 p-md-3 my-1 my-md-3 step" data-step="3">
                    <!-- FLAGS -->
                    <section class="flags d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <!-- Flags -->
                        <section  class="d-none mt-2" id="flagInputGroup">
                            <!-- Flag country input -->
                            ...
                            <!-- Flag position Radio Button -->
                            <?php foreach ($flag_positions as $key => $value): ?>
                                <?php if ($value[0]['active'] == 1): ?>
                                <div class="d-flex flex-wrap align-items-center justify-content-between settings my-2 p-3 accordion-label <?php if ($value[0]['checked'] == 1): ?>current<?php endif; ?>">

                                    <div class="form-check">
                                        <input class="form-check-input" 
                                        type="radio"
                                        name="flag"
                                        id="flagLabel_<?php echo $key; ?>"
                                        <?php if ($value[0]['checked'] == 1): ?>
                                            checked
                                        <?php endif; ?>
                                        >
                                        <label class="form-check-label" for="flagLabel_<?php echo $key; ?>">
                                            <?php echo htmlspecialchars($value[0]['title'][$lang]); ?>
                                        </label>
                                    </div>
                                    ...
                                    <div class="d-flex flex-wrap align-items-center justify-content-between settings py-1">
                                        ...
                                        <ul class="d-flex tools justify-content-start align-items-center gap-1" id="flagAlign_<?php echo $key; ?>">
                                        <?php foreach ($value[0]['align'] as $alignName => $alignData): ?>
                                            
                                            <?php if ($alignData['active'] == 1): ?>
                                                
                                                <li><button type="button"
                                                    class="flag tools <?= $alignData['current'] ? 'current' : '' ?>"
                                                    id="buttonFlag_<?php echo $key . '_' . $alignName; ?>"
                                                    data-position="<?php echo htmlspecialchars($value[0]['title'][$lang]); ?>"
                                                    <?php if ($alignData['current']): ?>
                                                        data-default="true"
                                                    <?php endif; ?>
                                                    data-align-name="<?php echo $translate['form']['marker']['tools']['font-align']; ?>: <?php echo htmlspecialchars($alignData['name'][$lang]); ?>"
                ...
                <div class="my-3 text-center">
                    ...
                    data-add="<?php echo $translate['form']['notification']['add-package'] ?>"
                    data-update="<?php echo $translate['form']['notification']['update-package'] ?>"
                    data-status="<?php echo $translate['package']['status'] ?>"
